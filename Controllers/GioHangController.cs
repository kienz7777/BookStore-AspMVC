...
namespace BookStoreASP.Controllers
{
    public class GioHangController : Controller
    {
        ...
        //Thêm giỏ hàng
        public ActionResult ThemGioHang(int iMaSach, string strURL, FormCollection f)
        {
            ...
            if (sanpham == null)
            {
                ...
                sanpham.iSoLuong = int.Parse(f["boot"].ToString());
                lstGioHang.Add(sanpham);
                return Redirect(strURL);
            }
            else
            {
                sanpham.iSoLuong = sanpham.iSoLuong + int.Parse(f["boot"].ToString());
                return Redirect(strURL);
            }
        }
